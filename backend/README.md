...
## Project Structure
    ...
    ├── testapiautosetting_124226  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_124226`
...
2. Clone this repo and `cd testapiautosetting_124226`
